    ...
    >
      ...
      <WidgetContent disablePadding className={classes.content}>
        <WidgetScrollPane className={classes.scrollContainer} onClick={focusOnClick} style={{ cursor: 'pointer' }}>
          <div className={clsx('notepad_selector', classes.notepadContainer)}></div>
        </WidgetScrollPane>
      </WidgetContent>
    </WidgetFrame>
  );
...
//    quillRef={quillRef}
//    spinner={
//      <Box display="flex" alignItems="center" justifyContent="center" width="100%" height="100%" p={4} margin="auto">
